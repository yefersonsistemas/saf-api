    ...
    <main>
        <img src="assets/images/Isotipo_S&F.svg" class="imgfondo">
            ...
            <div style="text-align:center;">
                <p class="titulo">INFORME MEDICO</p>
            </div>
            ...
            <div class="content">
                ...
                <div class="contenido">
                    <p>
                        La Presente es para Informar que all Paciente <span>{{ $itinerary->person->name }} {{ $itinerary->person->lastname }}</span>, Portador del documento de identidad: 
                        <span>{{ $itinerary->person->type_dni }} {{ $itinerary->person->dni }}</span>, presenta sintomas fuertes de una o más padencias que le aqueja, 
                        en el examen fisico y/o de laboratorio se observo lo siguiente: 
                    </p><br>
                    <p class="conte">
                    {{ html_entity_decode(strip_tags($itinerary->report_medico->descripction)) }}
                    </p>
                </div>
                <div class="fecha">
                    <p>
