        ...
        <div class="row clearfix justify-content-between">
            ...
            <div class="container">
                ...
                <ul class="nav nav-pills mb-3 mt-4 d-flex justify-content-end" id="pills-tab" role="tablist">
                    <li class="nav-item">
                        <a class="todos pt-0 pb-0 pr-4 pl-4"  id="pills-home-tab" data-toggle="pill" href="#todos" role="tab" aria-controls="todos" aria-selected="true">Todos</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class=" row tab-pane fast animated bounceInRight show active" id="todos" role="tabpanel" aria-labelledby="pills-home-tab">
                        <div class="col-lg-12">
                            <div class="mb-4 card ">
                    ...
                    <div class=" row tab-pane animated bounceInRight fast show " id="espera" role="tabpanel" aria-labelledby="pills-espera-tab">
                        <div class="col-lg-12">
                            <div class="card mb-4">
                                <div class="row card-body d-flex justify-content-between">
...
{{-- 
                <!--todas-->
                <div class="tab-content" id="pills-tabContent">
                <div class=" row tab-pane fast animated bounceInRight show active" id="todos" role="tabpanel" aria-labelledby="pills-todos-tab"> --}}
