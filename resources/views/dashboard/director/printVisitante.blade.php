    ...
    <main>
        ...
        <div id="header"></div>
            <div class="stuff">
                ...
                <ul>
                    <li>Documento de identidad: {{ $person->type_dni }} - {{ $person->dni }}</li>
                    <li>Nombre: {{ $person->name }}</li>
                    <li>Apellido: {{ $person->lastname }}</li>
                    <li>Dirección: {{ $person->address }}</li>
                    <li>Teléfono: {{ $person->phone }}</li>
                    <li>Correo electrónico: {{$person->email }}</li>
                </ul>
            </div>
  </main>
</body>
