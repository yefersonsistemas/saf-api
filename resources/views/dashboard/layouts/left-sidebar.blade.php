            ...
            <ul class="metismenu">
                ...
                @role('IN')
                    ...
                    <li class="@yield('cites')">
                        ...
                        <ul>
                            <li class="@yield('all')"><a href="{{ route('checkin.day') }}">Citas Del Dia</a></li>
                            <li class="@yield('all')"><a href="{{ route('checkin.approved') }}">Citas Aprobadas</a></li>
                            <li class="@yield('all')"><a href="{{ route('checkin.pending') }}">Citas Pendientes</a></li>
