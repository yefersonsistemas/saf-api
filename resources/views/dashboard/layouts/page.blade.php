                ...
                <div class="notification d-flex">
                    ...
                    <div class="dropdown d-flex">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                            ...
                            <a class="dropdown-item" href="#"><i class="dropdown-icon fe fe-settings"></i> Configuración</a>
                            ...
                            <a class="dropdown-item" href="#"><i class="dropdown-icon fe fe-send"></i> Mensajes</a>
                            <div class="dropdown-divider"></div>
                            {{-- <a class="dropdown-item" href="javascript:void(0)"><i class="dropdown-icon fe fe-help-circle"></i> Need help?</a> --}}
                            <form action="{{ route('logout') }}" method="post">
                                @csrf
                                <button type="submit" class="dropdown-item"><i class="dropdown-icon fe fe-log-out"></i> Cerrar sesión</button>
                            </form>
                        </div>
                    </div>
                </div>
