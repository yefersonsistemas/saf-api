        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 ">
                <div class="card">
                    <div class="card-body py-2">                                
                        ...
                        <h4 class="pt-2"><i class="fa fa-address-book"></i> <span class="counter"></span></h4>
                        {{-- <h5>$1,25,451.23</h5> --}}
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 ">
                <div class="card">
                    <div class="card-body py-2">
                        ...
                        <h4 class="pt-2"><i class="fa fa-calendar"></i> <span class="counter"></span></h4>
                        {{-- <h5>$3,80,451.00</h5> --}}
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 ">
                <div class="card">
                    <div class="card-body py-2">
                        ...
                        <h4 class="pt-2"><i class="fa fa-users"></i> <span class="counter"></span></h4>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 ">
                <div class="card">
                    <div class="card-body py-2">
                        <h6>Atendidos Hoy</h6>
                        <h4 class="pt-2"><i class="fa fa-user"></i> <span class="counter"></span></h4>
