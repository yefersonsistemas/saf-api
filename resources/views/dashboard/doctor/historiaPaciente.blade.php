...
<style type="text/css">
    ...
    button[data-original-title="Link (CTRL+K)"],
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group d-flex flex-row align-items-center">
                                                    ...
                                                    <input type="hidden" value="{{ $history->patient_id }}" id="patient">
                                                    <!--paciente-->
                                                    <input type="hidden" value="{{ $history->person_id }}" id="employe">
                                                    <!--Empleado-->
                                                    <input type="hidden" value="{{ $history->id }}" id="reservacion">
                                                    <!--reservation-->
        ...
        <div class="modal-content">
            ...
            <form action="" id="posible-surgerys">
                <div class="modal-body" style="max-height: 415px;">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col">Cirugias Hospitalarias</div>
                            <div class="col">Cirugias Ambulatorias</div>
                        </div>
                        <div class="row">
                            <div class="form-group">
                                <div class="custom-controls-stacked">
