...
<form action="{{ route('in-out.imprimir_factura') }}" method="POST" target="_blank">
    @csrf
        ...
        <div class="section-body py-3 col-10 ml-5 ">
            <div class="container">
                <div class="tab-content">
                     <!-----------------------Campos ocultoss---------------------->
                     <input id="person_id" type="hidden" name="person_id" value="" > <!--persona que va a pagar-->
                     <input type="hidden" name="factura" value="{{ $surgery->billing_id }}" > <!--numero de factura-->
                     <input type="hidden" name="total" value="{{ $total }}" > <!--numero de factura-->
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body mt-0 " style="top:-50px">
                                        ...
                                        <div class="row">
                                            ...
                                            <input type="hidden" id="paciente_id" name="paciente_id" value="{{ $surgery->patient->first()->person->id }}">
                                            <div class="col-lg-3 col-md-4 col-sm-12 pr-10 mb-2">
                                                <span id="dni" class="text form-control p-1 mt-0 text-left"><i class="fa fa-address-card"></i>&nbsp;&nbsp;{{ $surgery->patient->first()->person->dni }}</span>
                                            </div>
                                            <div class="col-lg-3 col-md-4 col-sm-12 mb-2">
                                                <span id="name" class="text form-control p-1 text-left"><i class="fa fa-user"></i>&nbsp;&nbsp;{{ $surgery->patient->first()->person->name }} {{ $surgery->patient->first()->person->lastname }}</span>
                                            </div>
                                            <div class="col-lg-3 col-md-4 col-sm-12 mb-2">
                                                <span id="phone" class="text form-control p-1 text-left"><i class="fa fa-phone"></i>&nbsp;&nbsp;{{ $surgery->patient->first()->person->phone }}</span><br>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-4 col-sm-12 pr-10 mb-2">
                                                <span class="text form-control p-1 text-left"><i class="fa fa-address-card"></i>&nbsp;&nbsp;{{ $surgery->employe->first()->person->dni }}</span>
                                            </div>
                                            <div class="col-lg-3 col-md-4 col-sm-12 pr-10 mb-2">
                                                <span class="text form-control p-1 text-left"><i class="fa fa-user-md"></i>&nbsp;&nbsp;{{ $surgery->employe->first()->person->name }} {{ $surgery->employe->first()->person->lastname }}</span>
                                            </div>
                                            <div class="col-lg-3 col-md-4 col-sm-12 pr-10 mb-2">
                                                <span class="text form-control p-1 text-left"><i class="fa fa-phone"></i>&nbsp;&nbsp;{{ $surgery->employe->first()->person->phone}}</span><br>
                                            </div>
                                        </div><br>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td colspan="5" class="text-left pl-4">
                                                            <div class="text-muted">Cirugía {{ $surgery->typesurgeries->name }}</div>
                                                        </td>
                                                        <td class="text-right" style="width: 1%">{{ number_format($total,2) }}</td>
                                                    </tr>
                                                </tbody> 
                                                <tr>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6 d-flex justify-content-start">
                                                <a href="{{route('in-out.day')}}" class="btn btn-boo pr-5 pl-5 mr-3">Salir</a>
                                            </div>
                                        </div>       
