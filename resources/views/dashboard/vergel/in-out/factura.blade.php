                                ...
                                <div class="card">
                                                                    <div class="card-body row my-8  pl-4">
                                                                        ...
                                                                        <div class="col-lg-8 col-md-8 col-sm-12 d-flex justify-content-end pr-3 pt-10" style="color:#000" >
                                                                            ...
                                                                            <span class="h6 h66 pt-0 pr-10">Fecha:</span><span class="text col-lg-4 col-md-7 col-sm-12" style="margin-bottom:50px"><i class="fa fa-calendar pl-20"></i>     </span><br>
                                                                        </div>                             
                                                                    </div>
                                                                    <div class="card-body mt-0 " style="top:-50px">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-3 col-md-4 col-sm-12 pr-10 mb-2">
                                                                                <span id="dni" class="text form-control p-1 mt-0 text-left"><i class="fa fa-address-card"></i>              </span>
                                                                                {{-- <span id="dni" class="text form-control p-1 mt-0 text-left"><i class="fa fa-address-card"></i>&nbsp;&nbsp;{{ $itinerary->person->dni }}</span> --}}
                                                                            </div>
                                                                            <div class="col-lg-3 col-md-4 col-sm-12 mb-2">
                                                                                <span id="name" class="text form-control p-1 text-left"><i class="fa fa-user"></i>                  </span>
                                                                            ...
                                                                            <div class="col-lg-3 col-md-4 col-sm-12 mb-2">
                                                                                <span id="phone" class="text form-control p-1 text-left"><i class="fa fa-phone"></i>         </span><br>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-3 col-md-4 col-sm-12 pr-10 mb-2">
                                                                                <span class="text form-control p-1 text-left"><i class="fa fa-address-card"></i>         </span>
                                                                                {{-- <span class="text form-control p-1 text-left"><i class="fa fa-address-card"></i>&nbsp;&nbsp;{{ $itinerary->employe->person->dni }}</span> --}}
                                                                            </div>
                                                                            <div class="col-lg-3 col-md-4 col-sm-12 pr-10 mb-2">
                                                                                <span class="text form-control p-1 text-left"><i class="fa fa-user-md"></i>       </span>
                                                                            ...
                                                                            <div class="col-lg-3 col-md-4 col-sm-12 pr-10 mb-2">
                                                                                <span class="text form-control p-1 text-left"><i class="fa fa-phone"></i>         </span><br>
                                                                    ...
                                                                    <div class="table-responsive push">
                                                                        <table class="table table-bordered table-hover mt-5">
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td colspan="5" class="text-left pl-4">
                                                                                        <div class="text-muted">Cirugía              </div>
                                                                            ...
                                                                            <tr class="bg-boo text-light">
                                                                                ...
                                                                                <td class="font700 text-right" id="costo_total">         </td>
