                                    ...
                                    <div class="card-body">
                                        <div class="row my-8">
                                            ...
                                            <div class="col-lg-6 col-md-12 col-sm-12">
                                                ...
                                                <!-----------------------Campos ocultoss---------------------->
                                                <input id="surgery_id" type="hidden" name="surgery_id" value="{{$surgery->id}}" > <!--guardar id de la cirugia-->
                                                <input id="patient_id" type="hidden" name="patient_id" value="{{$surgery->patient->first()->person->id}}" > <!--guardar id del paciente-->
                                                <input id="employe_id" type="hidden" name="employe_id" value="{{$surgery->employe->person->id}}" >  <!--guardar id del employe-->
                                                <input id="total" type="hidden" name="total_cancelar" value="{{$surgery->typesurgeries->cost}}" >   <!--guardar id del total a cancelar-->
                                                ...
                                                <div class="row ml-3">
                                                    ...
                                                    <div class="col-md-6 col-lg-6 col-sm-6">
                                                    <span id="dnii">{{$surgery->patient->first()->person->dni}}</span>
                                                    </div>
                                                </div>
                                                <div class="row ml-3">
                                                    <div class="col-md-6 col-lg-6 col-sm-6">
                                                    ...
                                                    <div class="col-md-6 col-lg-6 col-sm-6">
                                                    <span id="name">{{$surgery->patient->first()->person->name}}</span><span id="lastname">{{$surgery->patient->first()->person->lastname}}</span>
                                                    </div>
                                                </div>
                                                <div class="row ml-3">
                                                    <div class="col-md-6 col-lg-6 col-sm-6">
                                                    ...
                                                    <div class="col-md-6 col-lg-6 col-sm-6">
                                                        <span id="phone">{{$surgery->patient->first()->person->phone}}</span>
                                                    </div>
                                                </div><br>
                                            </div>
                                            ...
                                            <div class="col-lg-6 col-md-12 col-sm-12 text-left">
                                                ...
                                                <div class="row ml-3">
                                                    ...
                                                    <div class="col-md-6 col-lg-6 col-sm-6">
                                                        <span id="dniiD">{{$surgery->employe->person->dni}}</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row ml-3">
                                                    ...
                                                    <div class="col-md-6 col-lg-6 col-sm-6">
                                                        <span id="nameD">{{$surgery->employe->person->name}}</span><span id="lastnameD">{{$surgery->employe->person->lastname}}</span>
                                                    </div>
                                                ...
                                                <div class="row ml-3">
                                                    ...
                                                    <div class="col-md-6 col-lg-6 col-sm-6">
                                                        <span id="phoneD">{{$surgery->employe->person->phone}}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div><br><br>
                                        ...
                                        <div class="table-responsive push mt-3">
                                            <table class="table table-bordered table-hover" >
                                                ...
                                                <tbody id="cirugia">
                                                    @if($surgery->typesurgeries != null)
                                                    <tr>
                                                        <td colspan="5" class="pl-4">{{$surgery->typesurgeries->name}}</td>
                                                        <td class="text-right">{{number_format($surgery->typesurgeries->cost,2)}}</td>
                                                    {{-- </tr>    --}}
                                                    @endif
                                                </tbody>
                                                <tr>
                                                    <td colspan="5" class="font600 text-right">Subtotal</td>
                                                    <td class="text-right" id="subtotal">{{number_format($surgery->typesurgeries->cost,2)}}</td>
                                                </tr>
                                                <tr class="bg-boo  text-light">
                                                    <td colspan="5" class="font700 text-right">Total a cancelar</td>
                                                    <td class="font700 text-right" id="costo_total">{{number_format($surgery->typesurgeries->cost,2)}}</td>
                                                </tr>
                                            </table>
