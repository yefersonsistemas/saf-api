...
{{-- <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        ...
                        {{-- <div class="card mt-3">
                            ...
                            <div id="imgtext"></div>
                            </div>  <div class="dropzone row d-flex p-0" id="my-dropzone" style="border-color:#00506b; height:360px; overflow-y: scroll;" >
                        </div> --}}
...
<div class="py-4">
    <div class="container-fluid">
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <form id="wizard_horizontal" action="{{ route('guardar.informe', $surgery ) }}" method='POST' enctype="multipart/form-data" lass="card pl-4 pr-4">
                @csrf
                <h2>Informe del Internista</h2>
...
<script>
    Dropzone.options.myDropzone = {
        ...
        url: "{{ route('guardar.informe', $surgery ) }}",
            headers: {
